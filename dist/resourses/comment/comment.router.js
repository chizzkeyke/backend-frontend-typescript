...
routerComment.get('/comment/:idPost', comment_contoller_1.default.getCommentsSelectedPost);
routerComment.post('/comment/:idPost', comment_contoller_1.default.postCommentSelectedPost);
